package com.example.onehourapp.calendar
...
import com.example.onehourapp.presentation.helpers.pagerFanTransition
...
fun CalendarBackdropScaffold(changedMonth: MutableState<Int>) {
    ...
    val startIndex = Int.MAX_VALUE / 2 - 3 + com.example.onehourapp.common.utils.CalendarUtil.getCurrentMonth()
    ...
    val year = remember {
        mutableIntStateOf(com.example.onehourapp.common.utils.CalendarUtil.getCurrentYear())
    }
    LaunchedEffect(Unit) {
    ...
    BackdropScaffold(
        modifier = Modifier.background(com.example.onehourapp.theme.ui.BackgroundColor),
        backLayerBackgroundColor = com.example.onehourapp.theme.ui.BackgroundSecondColor,
        frontLayerScrimColor = Color.Transparent,
        frontLayerBackgroundColor = com.example.onehourapp.theme.ui.BackgroundSecondColor,
                ...
                Row {
                    ...
                    Box(
                        ...
                        Text(
                            ...
                            style = com.example.onehourapp.theme.ui.MainFont.copy(
                                fontSize = 20.sp,
        ...
        backLayerContent = {
            ...
            HorizontalPager(
                ...
                if (item == null)
                    com.example.onehourapp.presentation.components.ClockProgressIndicator(item == null)
                else
                    Column(
                        ...
                        val columns =
                            com.example.onehourapp.common.utils.CalendarUtil.getDaysInMonth(
                                pageIndex % 12,
                                year.value
                            ) + 1
                        val rows = 25
                        val spacing = 5.dp
                        val isCurrentMonth = pageIndex % 12 == com.example.onehourapp.common.utils.CalendarUtil.getCurrentMonth()
                        Canvas(
                            modifier = Modifier
                                .fillMaxSize()
                        ) {
                            drawRect(
                                color = com.example.onehourapp.theme.ui.BackgroundColor,
                            ...
                            for (row in 0 until rows) {
                                for (column in 0 until columns) {
                                    val isCurrentDay =
                                        (column == com.example.onehourapp.common.utils.CalendarUtil.getCurrentDay() && isCurrentMonth)
                                    val isCurrentHour = (column == com.example.onehourapp.common.utils.CalendarUtil.getCurrentDay() && isCurrentMonth && row == com.example.onehourapp.common.utils.CalendarUtil.getCurrentHour())
                                    ...
                                    if (row != 0) {
                                        ...
                                        if(column==0){
                                            drawText(
                                                style = com.example.onehourapp.theme.ui.CalendarDayFont,
                                        ...
                                        if(column!=0)
                                            drawText(
                                                style = if (isCurrentDay) com.example.onehourapp.theme.ui.CalendarCurrentDayFont else com.example.onehourapp.theme.ui.CalendarDayFont,
                                                text = "$column",
                                                textMeasurer = textMeasurer,
                                                topLeft = Offset(
                ...
                com.google.accompanist.pager.HorizontalPager(modifier = Modifier
                    ...
                    LazyColumn(
                        ...
                        when (page) {
                                ...
                                if (loadedCategories != null) {
                                    item {
                                        ...
                                        Box(
                                            ...
                                            val totalHours = 24f * com.example.onehourapp.common.utils.CalendarUtil.getDaysInMonth(pagerState.currentPage % 12)
                                    ...
                                    item {
                                        Column(verticalArrangement = Arrangement.Center) {
                                            ...
                                            if (listFirstCategory != null) {
                                                ...
                                                val ySteps = 25
                                                val xSteps = com.example.onehourapp.common.utils.CalendarUtil.getDaysInMonth(
                                                    pagerState.currentPage % 12,
                                                    year.value
                                                ) + 2
                                                        ...
                                                        Modifier
                                                            ...
                                                            .background(
                                                                brush = Brush.horizontalGradient(
                                                                    ...
                                                                    0.93f to com.example.onehourapp.theme.ui.BackgroundSecondColor,
                                                                    1f to com.example.onehourapp.theme.ui.BackgroundSecondColor
                                                                )
                                                            )
                                                    )
                                                    Text(
                            ...
                            1 -> {
                                val isCurrentMonth = month == com.example.onehourapp.common.utils.CalendarUtil.getCurrentMonth()
                                val itemsCount = if(isCurrentMonth) com.example.onehourapp.common.utils.CalendarUtil.getCurrentDay() else com.example.onehourapp.common.utils.CalendarUtil.getDaysInMonth(month)
                                for(dayNumber in itemsCount downTo 1){
                                    ...
                                    item{
                                        ...
                                        if(!isListEmpty) {
                                            val dayText = if(isCurrentMonth && dayNumber == com.example.onehourapp.common.utils.CalendarUtil.getCurrentDay())
                                                stringResource(id = R.string.today)
                                            else if(isCurrentMonth && dayNumber == com.example.onehourapp.common.utils.CalendarUtil.getCurrentDay() - 1)
                                            ...
                                            Spacer(modifier = Modifier
                                                ...
                                                .background(
                                                    com.example.onehourapp.theme.ui.MainColorSecondRed
                                                )
                                                .height(3.dp)
                                                .fillMaxWidth())
                                        }
    ...
    if (!isLoaded)
        Box(
            ...
            com.example.onehourapp.presentation.components.ClockProgressIndicator(isLoaded)
        }
}
...
fun getBarDataListByCategoryInMonth(
    ...
    val maxX = com.example.onehourapp.common.utils.CalendarUtil.getDaysInMonth(month, year)
